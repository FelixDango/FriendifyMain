    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            try
            {
                ...
                var followedUsers = currentUser.Follows.Select(f => f.User).ToList();
        ...
        public async Task<IActionResult> Create(Post post)
        {
            try
            {
                ...
                if (ModelState.IsValid && !string.IsNullOrEmpty(post.Content))
                {
                    ...
                    post.Id = "Should be Automatically generated!!"; // The id will be generated by the database automatically
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                ...
                if (post.User == currentUser || currentUser.isModerator || currentUser.isAdmin)
                {
